...
function App() {
  ...
  return (
    <div>
      <div className='container flex sm:flex-col md:flex-row lg:flex-row mt-20 items-center justify-center'>
        <div className='left ml-36 w-4/5 mb-6 md:flex-col md:justify-center md:items-center'>
        ...
        <div className='right flex flex-col bg-white p-8 rounded-lg shadow-lg items-center w-[396px] mr-40 relative'>
